...
def count_and_concatenate(folder_path):
    ...
    if df_list:
        ...
        print("Duplicates removed based on 'uuid' column.")
        return final_df
    else:
...
if concatenated_df is not None:
    concatenated_df.to_csv(download_path + "concatenated_output.csv", index=False)
    print("Concatenated file saved as 'concatenated_output.csv'")
